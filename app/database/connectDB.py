    ...
    def create_tickets_table(self):
        sqlcommandforQuestions = (
            ...
            CREATE TABLE IF NOT EXISTS tickets(ticket_id SERIAL PRIMARY KEY, ticket_assigned_to VARCHAR(250),
             ...
             ticket_complete_time TIME,ticket_return_time TIME,ticket_additional_note VARCHAR(250),ticket_site_id VARCHAR(200),username VARCHAR(100), ticket_type smallint, ticket_part_used VARCHAR(100), ticket_revisited VARCHAR(100), ticket_part_returned VARCHAR(100))
             """
        )
